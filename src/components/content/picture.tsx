...
function Picture({
  ...
  return (
    <figure className={cn("my-6 md:my-8", className)}>
      ...
      {caption && (
        <figcaption className="mx-auto mt-3 max-w-2xl overflow-hidden text-center text-sm font-medium tracking-tight text-ellipsis text-muted-foreground md:text-base">
          {caption}
        </figcaption>
      )}
    </figure>
