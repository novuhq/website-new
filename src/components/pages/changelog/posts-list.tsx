  ...
  return (
    ...
    >
      <div className="w-full px-5">
        ...
        <ul
          className={cn(
            "relative mx-auto max-w-160 lg:max-w-214 xl:max-w-246",
        ...
        >
          {posts.map(
            (
              ...
              <li key={index}>
                <article className="grid grid-cols-1 gap-3.25 md:gap-5 lg:grid-cols-[112px_1fr] lg:gap-15">
                  <p
                    className={cn(
                      "relative lg:mt-3.75 lg:pl-0.5",
                      "after:absolute after:top-0.75 after:right-0 after:hidden after:size-2 after:rounded-full after:bg-purple-2 lg:after:block"
                    )}
                  >
