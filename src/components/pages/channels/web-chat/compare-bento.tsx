    ...
    <section>
      <div className="mx-auto w-full max-w-3xl px-5 md:px-8 lg:max-w-336">
        <div className="flex flex-col gap-5 md:gap-7 lg:flex-row lg:items-start lg:justify-between lg:gap-12">
          ...
          <p className="text-[16px] leading-[1.5] tracking-[-0.025em] text-white/80 md:text-[18px] md:text-[#A3A6B2] lg:max-w-[604px] lg:pt-2">
            {COMPARE_DESCRIPTION}
          </p>
        </div>

        <div className="mt-10 flex flex-col gap-5 md:mt-14 md:gap-10 xl:flex-row xl:items-center xl:gap-6">
          <OldWidgetCard />
          <WebChatCard />
        </div>
      </div>
