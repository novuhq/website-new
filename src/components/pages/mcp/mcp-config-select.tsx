...
function McpConfigSelect({ snippets, defaultLabel }: IMcpConfigSelectProps) {
  ...
  return (
    <div className="relative flex aspect-[4/4] w-full min-w-0 flex-col overflow-hidden rounded-xl min-[460px]:aspect-[4/3] sm:aspect-[640/374] md:aspect-[4/3] lg:aspect-[640/374]">
      <McpSnippetBg />
