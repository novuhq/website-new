      ...
      <ul className="flex flex-col overflow-hidden rounded-[8px] border border-gray-3">
        {customers?.map((customer) => {
          ...
          return (
            <li key={customer._id}>
              <Link
                className="flex flex-col items-start gap-y-2.5 border-b border-gray-3 p-4 pb-3.5 transition-colors duration-200 last:border-b-0 hover:bg-gray-3"
                href={
                  customer.slug
              ...
              >
                <span className="text-sm leading-none font-medium tracking-tighter text-lagune-3 capitalize">
                  Customer story
                </span>
