...
const Reviews = ({ reviews }: { reviews: any[] }) => {
  return (
    <section className="reviews relative mt-[104px] md:mt-28 lg:mt-[180px]">
      <div className="relative mx-auto flex w-full max-w-[1216px] flex-col items-center px-5 text-center md:px-8 lg:px-0">
      <span className="absolute top-1/2 left-1/2 flex h-full w-full -translate-x-1/2 -translate-y-1/2 rounded-[1152px] bg-[linear-gradient(168deg,rgba(245,117,224,0.8)_26.46%,rgba(164,123,243,0.87)_40.2%,rgba(178,129,242,0.8)_53.94%,rgba(117,153,245,0.95)_79.63%)] opacity-[0.07] blur-[125px]"></span>
