      ...
      content: [
        {
          items: [
            ...
            },
            {
              ...
              menuIcon: "chat",
              children: [
                { label: "Squarespace", href: ROUTE.webChatSquarespace },
                { label: "Wix", href: ROUTE.webChatWix },
                { label: "Webflow", href: ROUTE.webChatWebflow },
                { label: "Framer", href: ROUTE.webChatFramer },
                { label: "Bubble", href: ROUTE.webChatBubble },
                { label: "Bolt.new", href: ROUTE.webChatBolt },
                { label: "Lovable", href: ROUTE.webChatLovable },
                { label: "v0", href: ROUTE.webChatV0 },
                { label: "Base44", href: ROUTE.webChatBase44 },
                { label: "Replit", href: ROUTE.webChatReplit },
              ],
            },
          ],
        },
